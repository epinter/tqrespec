...
public class PlayerFileVariable implements IFileVariable {
    ...
    static {
        ...
        map.put("seed", new PlayerFileVariable("seed", VariableType.INTEGER, FileBlockType.PLAYER_ITEM));
        map.put("var1", new PlayerFileVariable("var1", VariableType.INTEGER, FileBlockType.PLAYER_ITEM));
        map.put("var2", new PlayerFileVariable("var2", VariableType.INTEGER, FileBlockType.PLAYER_ITEM));
        ...
        map.put("baseName", new PlayerFileVariable("baseName", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("prefixName", new PlayerFileVariable("prefixName", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("suffixName", new PlayerFileVariable("suffixName", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("relicName", new PlayerFileVariable("relicName", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("relicBonus", new PlayerFileVariable("relicBonus", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("relicName2", new PlayerFileVariable("relicName2", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("relicBonus2", new PlayerFileVariable("relicBonus2", VariableType.STRING, FileBlockType.PLAYER_ITEM));
        map.put("useAlternate", new PlayerFileVariable("useAlternate", VariableType.INTEGER, FileBlockType.PLAYER_EQUIPMENT));
        map.put("equipmentCtrlIOStreamVersion", new PlayerFileVariable("equipmentCtrlIOStreamVersion", VariableType.INTEGER, FileBlockType.PLAYER_EQUIPMENT));
        map.put("storedType", new PlayerFileVariable("storedType", VariableType.INTEGER, FileBlockType.PLAYER_HOT_SLOT));
        map.put("itemAttached", new PlayerFileVariable("itemAttached", VariableType.INTEGER, FileBlockType.PLAYER_EQUIPMENT));
